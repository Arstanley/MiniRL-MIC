...
define([
    ...
    function RLSimulatorControl(options) {
    ...
    RLSimulatorControl.prototype._initWidgetEventHandlers = function () {
    ...
    RLSimulatorControl.prototype.selectedObjectChanged = function (nodeId) {
...
RLSimulatorControl.prototype._getObjectDescriptor = function (nodeId) {
    ...
    RLSimulatorControl.prototype._stateActiveObjectChanged = function (model, activeObjectId) {
    ...
    RLSimulatorControl.prototype.destroy = function () {
        this._detachClientEventListeners();
        this._removeToolbarItems();
    };

    RLSimulatorControl.prototype._attachClientEventListeners = function () {
        this._detachClientEventListeners();
        WebGMEGlobal.State.on('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged, this);
    };

    RLSimulatorControl.prototype._detachClientEventListeners = function () {
        WebGMEGlobal.State.off('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged);
    };

    RLSimulatorControl.prototype.onActivate = function () {
    ...
    RLSimulatorControl.prototype.onDeactivate = function () {
        this._detachClientEventListeners();
        this._hideToolbarItems();
    };

    /* * * * * * * * * * Updating the toolbar * * * * * * * * * */
    RLSimulatorControl.prototype._displayToolbarItems = function () {
    ...
    RLSimulatorControl.prototype._hideToolbarItems = function () {
    ...
    RLSimulatorControl.prototype._removeToolbarItems = function () {
    ...
    RLSimulatorControl.prototype._initializeToolbar = function () {
        var self = this,
