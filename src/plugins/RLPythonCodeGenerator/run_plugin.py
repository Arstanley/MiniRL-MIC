"""
This script is called by the plugin-wrapper, RLPythonCodeGenerator.js, which passes down the
...
from RLPythonCodeGenerator import RLPythonCodeGenerator
...
plugin = RLPythonCodeGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
